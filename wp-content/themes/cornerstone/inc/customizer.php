...
function cornerstone_customize_register( $wp_customize ) {
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'cornerstone_customize_partial_blogname',
		) );
 ...
 * @return void
 */
function cornerstone_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function cornerstone_customize_partial_blogdescription() {
 ...
 */
function cornerstone_customize_preview_js() {
